...
export const ButtonStyle: ComponentStyleConfig = {
  ...
  variants: {
    solid: (props: StyleFunctionProps) => {
      ...
      if (c === 'brand') {
        return {
          bg: 'background.button.brand.base',
          color: mode('text.link', 'text.inverse')(props),
          _hover: {
            bg: 'background.button.brand.hover',
            textDecoration: 'none',
            _disabled: {
              bg: 'background.button.brand.base',
            },
          },
          _active: { bg: 'background.button.brand.pressed' },
          _checked: { bg: 'background.button.brand.pressed' },
        }
      }
      if (c === 'gray') {
        return {
